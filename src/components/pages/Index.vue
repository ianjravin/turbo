<template lang="pug">
  .content
    ...
    section.info
      h2.aside-title HOW IT WORKS
      .info-item
        h4.info-title From the lender
        p.
    ...
    section.comments
      ...
      .comment(v-for='n in 4')
        ...
        cite.comment-author Ian, Nouveta
        blockquote.comment-text
          | This is a fantastic idea, & am on board.
</template>
...
export default {
  ...
  data() {
    return {
      ...
      slides: [{
        name: 'main',
        title: 'Welcome to our loans platform!',
        text: 'We help people seeking loans, crowdfund and raise the amount they need\
        around the world',
      }, {
        name: 'team',
        title: 'Welcome to our loans platform!',
